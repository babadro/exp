...
<cfoutput>
	<form action = "#cgi.script_name#" method = "post">
		...
		<i>shop up to
		<input name = "SearchMaxRows" value = "#searchMaxRows#" size = "2">matches</i><br>
...
<cfif searchCriteria neq "">
	<cfquery name = "getMatches">
		...
		OR Summary LIKE
		<cfqueryparam cfsqltype = "cf_cql_varchar" value = "%#SearchCriteria#%">
		ORDER BY MovieTitle
	</cfquery>
	
	<cfoutput>
		<hr><i>#getMatches.recordCount# records found for "#searchCriteria#"</i><br>
	</cfoutput>
