...
<cfcomponent hint="Search and display films">
  ...
  <cffunction name="listFilms" returnType="query" output="false" access="remote" hint="Search for a film, and return a query with the id and title of the matching films." returnFormat="JSON">
