...
<CFIF WasFormSubmitted>
  <!--- Execute the stored procedure via SQLServer's EXEC command --->
  ...
  <CFSET InsertStatus = ExecProc.StatusCode>
  <CFSET InsertedFilmID = ExecProc.NewFilmID>
</CFIF>
