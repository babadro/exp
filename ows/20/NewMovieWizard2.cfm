...
<cfform 
 ...
 size="50"
 required="Yes"
 message="Please don�t leave the movie title blank."
 ...
 required="Yes"
 validate="float"
 message="Please provide a number for the director�s salary."
 value="#SESSION.movWiz.directorSal#">
 
 <!--- Salary for each actor --->
 <p>How much will we pay the Actors?<br>
 <cfloop query="getActors">
 <!--- Grab actors�s salary from ActorSals structure --->
 ...
 required="Yes"
 validate="float"
 message="Please provide a number for each actor�s salary."
